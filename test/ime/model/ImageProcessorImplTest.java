...
public class ImageProcessorImplTest {
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
      ...
      while ((line = br.readLine()) != null) {
        if (currentLine == lineWithP3) {
          ...
          assertEquals(width, processor.get("paris").getWidth());
          assertEquals(height, processor.get("paris").getHeight());
        }
        currentLine++;
      }
  ...
  public void testLumaComponent() throws IOException {
    ...
    ImageModel parisJpg = processor.get("paris-jpg");

    filePath = "test/res/paris.png";
    processor.load("paris-png", factory.getImageHelper(filePath).readImage(filePath));
    ImageModel parisPng = processor.get("paris-png");

    processor.lumaGrayscale("paris-jpg", "paris-jpg-luma");
    processor.lumaGrayscale("paris-png", "paris-png-luma");
    processor.lumaGrayscale("paris", "luma");

    ImageModel luma = processor.get("luma");
    ImageModel lumaPng = processor.get("paris-png-luma");
    ImageModel lumaJpg = processor.get("paris-jpg-luma");
  ...
  public void testIntensityComponent() {
    processor.intensityGrayscale("paris", "intensity");
    ImageModel intensity = processor.get("intensity");
  ...
  public void testGetValueGreyscale() {
    processor.valueGrayscale("paris", "value");
    ImageModel result = processor.get("value");
  ...
  public void testSplitAndCombine() {
    ...
    ImageModel red = processor.get("red");
    ImageModel green = processor.get("green");
    ImageModel blue = processor.get("blue");
    ...
    processor.rgbCombine("red", "green", "blue",
            "combined");
    ImageModel combined = processor.get("combined");
    for (int i = 0; i < image.getHeight(); i++) {
      for (int j = 0; j < image.getWidth(); j++) {
  ...
  public void testVerticalFlip() {
    ...
    ImageModel vertical = processor.get("paris-vertical");
  ...
  public void testHorizontalFlip() {
    ...
    ImageModel horizontal = processor.get("paris-horizontal");
  ...
  public void testFlipTwiceSame() {
    ...
    ImageModel verticalOriginal = processor.get("paris-vertical-twice");

    processor.horizontalFlip("paris", "paris-horizontal");
    processor.horizontalFlip("paris-horizontal", "paris-horizontal-twice");
    ImageModel horizontalOriginal = processor.get("paris-horizontal-twice");
  ...
  public void testSepia() throws IOException {
    ...
    processor.load("paris-png", factory.getImageHelper(filePath).readImage(filePath));
    ImageModel expectedSepiaPng = processor.get("paris-expected-png");


    processor.sepia("paris-png", "paris-sepia-png");

    ImageModel result = processor.get("paris-sepia-png");
