...
import image_manipulation.utils.ImageProcessorUtil;
...
public class ImageProcessorImpl implements ImageProcessor {
    ...
    public void sepia(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).colorTransform(ImageProcessorUtil.SEPIA_TRANSFORMER));
    }

    @Override
    public void redGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.RED));
    }

    @Override
    public void blueGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.BLUE));
    }

    @Override
    public void greenGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.GREEN));
    }

    @Override
    public void lumaGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.LUMA));
    }

    @Override
    public void valueGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.VALUE));
    }

    @Override
    public void intensityGrayscale(String imgName, String destImgName) {
        this.images.put(destImgName, this.get(imgName).grayscale(Component.INTENSITY));
    }
