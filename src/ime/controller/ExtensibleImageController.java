...
public class ExtensibleImageController implements ExtensibleImageControllerInterface {
  private Readable in;
   ...
   */
  @Override
  public void execute(ExtensibleImageProcessor imageProcessor) throws IOException {
